...
\newcommand{\pdlfunction}[2]{\ensuremath{\jsobj{\mtt{function:}{#1}\mtt{,}  \mtt{return:}{#2}}}}
\newcommand{\pdlclosure}[3]{\ensuremath{\jsobj{\mtt{function:}{#1}\mtt{,}  \mtt{return:}{#2}, \mtt{scope:}{#3}}}}
...
\newcommand{\pdlSemc}[3]{\ensuremath{{#1} \vdash {#2} \Downarrow {#3}}}
\newcommand{\pdlSeme}[3]{\ensuremath{{#1} \vdash {#2} \Downarrow {#3}}}

\newcommand{\pdlhole}{\ensuremath{[\,]}}
\newcommand{\pdlsemp}[5]{\ensuremath{{#1}, {#2} \Rightarrow {#3}, {#4}, {#5}}}
\newcommand{\pdlsembb}[5]{\ensuremath{{#1}, {#2} \rightarrow {#3}, {#4}, {#5}}}
...
% \begin{array}{lcl}
%     \mit{document\_ctx} & ::= &\ 
%         \jsarr{\mit{block\_ctx}\mtt{,} \dots\mtt{,} \mit{block}}
%     \\
%     \mit{block\_ctx} & ::= &\
%     \pdlblock[\mit{show}]{x}{\mit{block\_body\_ctx}}
%     \\ &&\mid
%     \pdlblockdefs{\mit{defs\_ctx}}{\pdlblockstar[\mit{show}]{x}{\mit{block\_body}}}
%     % \\ &&\mid
%     % \pdlblockdefs{\mit{defs}}{\pdlblockstar[\mit{show}]{x}{\mit{block\_body\_ctx}}}
%     \\
%     \mit{defs\_ctx} & ::= &\
%     \jsobj{\pdldef{x}{\mit{block\_body\_ctx}}\mtt{,} \dots\mtt{,}\pdldef{x}{\mit{block\_body}}}
%     \\
%     \mit{block\_body\_ctx} & ::= &\ 
%     \pdlhole
%     \\ &&\mid
%     \pdlmodel{\mit{model}}{\mit{document\_ctx}}
%     \\ &&\mid
%     \pdlcode{\mit{document\_ctx}}
%     \\ &&\mid
%     \pdlapi{\mit{url}}{\mit{api}}{\mit{document\_ctx}}
%     % \\ &&\mid
%     % \pdlget{\mit{x}}
%     % \\ &&\mid
%     % \pdldata{\mit{json}}
